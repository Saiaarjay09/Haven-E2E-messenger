...
![Signup form filled in](docs/screenshots/02-signup-filled.png)
...
![Recovery phrase screen](docs/screenshots/03-recovery-phrase.png)
...
![Empty app screen](docs/screenshots/04-empty-app.png)
...
![Search results dropdown](docs/screenshots/05-search-results.png)

Click their name to send them a contact request.

![Request sent confirmation](docs/screenshots/06-request-sent-modal.png)

Until they respond, they show up in your Chats list as pending — there's
nothing to open yet.

![Pending contact in the sidebar](docs/screenshots/07-pending-in-chats.png)
...
![Requests tab with Accept/Decline](docs/screenshots/08-requests-tab.png)
...
![Open chat, typing a message](docs/screenshots/09-chat-open.png)
...
![Conversation with safety number highlighted](docs/screenshots/10-chat-conversation.png)
...
![Settings tab showing the user's own contact card](docs/screenshots/11-my-contact-card.png)
...
![Paste a contact card fallback](docs/screenshots/12-add-contact-card.png)
